...
if( ! defined( 'GIWEATHER_VERSION' ) ) {
	define( 'GIWEATHER_VERSION', '1.1.0' );
}
...
class giWeather extends WP_Widget {
	...
	public function form( $instance ) {
		// outputs the options form on admin
		wp_enqueue_script('giweather-form',plugins_url( '/extras/lib_giweather/js/giweather-form.js' , __FILE__ ),	array( 'jquery' ),GIWEATHER_VERSION);
