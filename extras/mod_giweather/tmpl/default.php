...
<div id="giweather-module-<?php echo $module->id;?>" class="giweather<?php echo $moduleclass_sfx; ?>" style="<?php echo $style;?>max-width:<?php echo $widget_max_width; ?>"><div class="giweather-widget giw-loading">	
</div>
